...
async def scout_page(base_url: str) -> list:
    """Generate QA tasks for testing the website"""
    return [
        f"Navigate to {base_url} and test all navigation links, buttons, and interactive elements for functionality",
        f"Visit {base_url} and check for broken images, missing content, and layout issues across the page",
        f"Go to {base_url} and test form submissions, search functionality, and any user input features",
        f"Browse {base_url} and evaluate accessibility features like alt text, keyboard navigation, and color contrast",
        f"Explore {base_url} and test mobile responsiveness, page loading speed, and cross-browser compatibility issues",
        f"Check {base_url} for JavaScript errors, console warnings, and any technical issues that affect user experience"
    ]
...
"""
        ...
        summary.update({
            ...
            "no_llm_analysis": "Google API key not available for detailed analysis"
        })
